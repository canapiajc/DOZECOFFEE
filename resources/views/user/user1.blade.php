   ...
   <body>
                  ...
                  <div class="carousel-inner">
                     ...
                     <div class="carousel-item">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Choose Your Fav Coffee!</h1>
                                 <h5 class="tasty_text">Tasty Of DozeCafe</h5>
                                 <p class="banner_text">more-or-less normal distribution of letters, as opposed to using </p>
                                 <div class="btn_main">
                                    <div class="about_bt"><a href="#">About Us</a></div>
                     ...
                     <div class="carousel-item">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Best Coffee Ever!</h1>
                                 <h5 class="tasty_text">Tasty Of DozeCafe</h5>
                                 <p class="banner_text">more-or-less normal distribution of letters, as opposed to using </p>
                                 <div class="btn_main">
                                    <div class="about_bt"><a href="#">About Us</a></div>
                     ...
                     <div class="container-fluid">
                        <div class="row">
                           <div class="col-lg-3 col-md-6">
                              ...
                              <h3 class="types_text">TYPES OF COFFEE</h3>
                              <p class="looking_text">looking at its layout. The point of</p>
                              <div class="read_bt"><a href="#">ADD</a></div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="coffee_img"><img src="images/img-2.png"></div>
                              <h3 class="types_text">BEAN VARIETIES</h3>
      ...
      <div class="client_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="about_taital">REVIEWS</h1>
                  <div class="bulit_icon"><img src="images/bulit-icon.png"></div>
               </div>
            </div>
            <div class="client_section_2">
               <div class="client_taital_main">
                  ...
                  <div class="client_right">
                     <h3 class="moark_text">Junatan Canapia</h3>
                     <p class="client_text">Masarap at sulit pa  </p>
                  </div>
               </div>
               <div class="client_taital_main">
                  <div class="client_left">
                  ...
                  <div class="client_right">
                     <h3 class="moark_text">Gieo Rosal</h3>
                     <p class="client_text">The best talaga to guys! </p>
                  </div>
               </div>
               <div class="client_taital_main">
                  <div class="client_left">
                  ...
                  <div class="client_right">
                     <h3 class="moark_text">Sarah Grace</h3>
                     <p class="client_text">huhu ang mura pa  </p>
                  </div>
               </div>
            </div>
         </div>
