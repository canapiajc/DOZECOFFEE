        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Show ORDER(s)</h1>
                ...
                <table class="table">
                    ...
                    <td><input type="text" name="baranggay[]" value="{{$orders->address}}"hidden>{{$orders->baranggay}}</td>
                    <td><input type="text" name="zip[]" value="{{$orders->address}}"hidden>{{$orders->zip}}</td>
                    <td><input type="text" name="productname" value="{{$orders->product_name}}"hidden>{{$orders->product_name}}</td>
