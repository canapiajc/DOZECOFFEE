...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="buttons">ADD PRODUCTS</a>
                        <a class="collapse-item" href="admin.cards">All Products</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Product/s</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" name="title" class="form-control" id="Productname" aria-describedby="emailHelp" placeholder="Product Name">
  ...
  <div class="form-group">
    ...
    <input type="text"name="desc" class="form-control" id="desc" aria-describedby="emailHelp" placeholder="Description">
